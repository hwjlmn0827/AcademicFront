...
function totalNumStatisticAjax(categoryTreeName) {
    $.ajax({
        type: "get",
        url: prefixUrl + "statistics/categoryTree/count?categoryTreeName="+categoryTreeName,
        data: {
        },
        async: true,
        dataType: "json",
...
function totalChartAjax(categoryTreeName) {
    $.ajax({
        type: "get",
        url: prefixUrl + "statistics/categoryTree/year?categoryTreeName="+categoryTreeName,
        data: {
        },
        async: true,
        dataType: "json",
...
function totalModalAjax(categoryTreeName) {
    $.ajax({
        type: "get",
        url: prefixUrl + "statistics/user/count",
        data: {
